...
<div class="img_row">
    <img class="col three left" src="{{ site.baseurl }}/assets/img/bmsup.JPG" alt="" title="Binding Media"/>
</div>
<div class="col three caption">
    _Binding Media. Print-Digital Literature from across the Americas_ (SUP 2025)
</div>
